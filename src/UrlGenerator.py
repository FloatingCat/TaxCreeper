...
def ProcessLoc(url,total):
    ...
    for index in range(1, total + 1):
        ...
        for a in aContent:
            ...
            linkbuffer='https://sichuan.chinatax.gov.cn'+linkbuffer.replace('../..','')
...
def ProcessLocal():
    ...
    for item in locationDict:
        ...
        amount=int(re.findall(r'\d+',pageAmount)[0])
        print(amount)
        # Amount=pageAmount.split('\r')[1]
        UGenerator(ProcessLoc(locationDict[item],amount),item)



if __name__ == '__main__':
    #url = 'https://sichuan.chinatax.gov.cn/module/search/index.jsp?field=vc_name:1:0,field_302:1:0,field_309:7:0,field_314:1:0,field_315:1:0,field_316:1:0,field_384:10:0&i_columnid=8803&field_384,0_start=&field_384,0_end=&vc_name=&field_302=&field_314=&field_315=&field_316=&field_309,0=&currpage='
    #UGenerator(ProcessLoc(url,5), 'sichuan')
    ProcessLocal()
